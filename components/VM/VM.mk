...
VM_CFILES   := $(wildcard ${CURRENT_DIR}/src/*.c)
VM_OFILES   := archive.o
VM_HFILES := $(wildcard ${CURRENT_DIR}/src/*.h)
VM_LIBS += sel4allocman elf sel4simple sel4simple-default cpio sel4arm-vmm sel4dma
